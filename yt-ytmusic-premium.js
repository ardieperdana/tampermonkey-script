    ...
    function initYoutube() {
        ...
        style.textContent = `
            ...
            #logo-icon-container {
                ...
                content:url("${LOGO.youtube.light}")!important;
            }

            html[dark] #logo-container .logo,
            html[dark] .footer-logo-icon,
            html[dark] #logo-icon,
            html[dark] #logo-icon-container{
                content:url("${LOGO.youtube.dark}")!important;
            }
        `;
...
function initMusic() {
    ...
    logo.setAttribute("logo-src", LOGO.music.dark);
    logo.setAttribute("white-logo-src", LOGO.music.light);
}
